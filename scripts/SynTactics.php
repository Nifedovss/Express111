...
##################################################
Function SHTML() {
    highlighterSynEdit('TSynEdit1', 'Form1.SynHTML');
}

Function SPHP() {
    highlighterSynEdit('TSynEdit1', 'Form1.SynPHP');
}

Function SGeneral() {
    highlighterSynEdit('TSynEdit1', 'Form1.SynGeneral');
}

Function SCpp() {
    highlighterSynEdit('TSynEdit1', 'Form1.SynCpp');
}

Function SCss() {
    highlighterSynEdit('TSynEdit1', 'Form1.SynCss');
}

Function SSQL() {
    highlighterSynEdit('TSynEdit1', 'Form1.SynSQL');
}

Function SJScript() {
    highlighterSynEdit('TSynEdit1', 'Form1.SynJScript');
}

Function SXML() {
    highlighterSynEdit('TSynEdit1', 'Form1.SynXML');
}
